...
- **Books:** whenever a player collects all four cards of a rank, that's a book — it's set aside and those four cards leave their hand. This can happen during the initial deal itself, not just during play — if a player is dealt all four cards of a rank, the book forms immediately and their hand ends up smaller than the nominal deal size (7 or 5) by four.
