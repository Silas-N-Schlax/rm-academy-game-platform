...
ActiveModel::SecurePassword.min_cost = true unless Rails.env.production?

if Rails.env.production?
  create(:user, name: "admin", email_address: "admin@rolemodel.test")
  puts "Done: 1 user seeded. Log in as admin@rolemodel.test / password."
else
